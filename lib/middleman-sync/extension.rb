...
module Middleman
  module Sync
    class Extension < Middleman::Extension
      ...
      DEPRECATED_ASSET_SYNC_CREDENTIAL_OPTIONS = %i(aws_access_key_id aws_secret_access_key rackspace_username rackspace_api_key rackspace_auth_url google_storage_access_key_id google_storage_secret_access_key path_style)
      DEPRECATED_ASSET_SYNC_OPTIONS = %i(fog_provider fog_directory fog_region existing_remote_files gzip_compression after_build)
