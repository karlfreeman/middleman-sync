  ...
  module Sync
    ...
    class Extension < Middleman::Extension
      ...
      def initialize(app, options_hash={}, &block)
        ...
        if DEPRECATED_OPTIONS.all? {|deprecated_option| opts.key?(deprecated_option) }
          puts 'Deprecated :sync options detected...'
          puts ":gzip_compression no longer supported" unless opts[:gzip_compression].nil?
          ...
          MultiSync.run_on_build = opts[:after_build]
